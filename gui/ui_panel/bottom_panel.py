...
class BottomPanel:
    def __init__(self, manager):
        ...
        self.container_rect = pygame.Rect((0, SCREEN_HEIGHT - 100), (SCREEN_WIDTH, 100))
        ...
        self.main_layout = HBoxLayout(self.panel_container, padding=10, spacing=20, mode='proportional',
                                      manager=self.manager)
    ...
    def _create_time_management_section(self):
        ...
        self.main_layout.add_layout(self.time_management_layout)
    ...
    def _create_second_part_section(self):
        ...
        self.main_layout.add_layout(self.second_part_layout)
