...
class FrictionToolUI(FrictionTool, BaseUIBox):
    def __init__(self, name, position, size=(30, 30), ico_path=None, color=(150, 150, 150), friction=0.5):
...
class ElasticityToolUI(ElasticityTool, BaseUIBox):
    def __init__(self, name, position, size=(30, 30), ico_path=None, color=(150, 150, 150), elasticity=0.5):
